...
let data = new SlashCommandBuilder()
    .setName("demote")
    .setDescription("Demote a player one rank down")
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await interaction.reply({embeds: [{title: `Demoted **${username}**`,color: 2752256,fields: [{name: "Old rank",value: oldrankName,inline: true},{name: "New rank",value: newRankName,inline: true}],footer: {text: interaction.user.tag,icon_url: interaction.user.displayAvatarURL()}}]});
    }
}